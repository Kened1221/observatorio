...
const DATABASE_OPTIONS = [
    { value: "poblacionCursoVida", label: "Población por curso de vida" },
    { value: "ninosAnemia", label: "Anemia" },
    { value: "ninosNutricion", label: "Desnutrición" },
    { value: "ninosDengue", label: "Dengue" },
];

export default function ContainerQuality() {
        ...
        <Card className="shadow-lg w-full mx-auto">
            <CardHeader>
                <CardTitle className="text-2xl sm:text-3xl font-semibold">
                    Panel de Datos subidos en Vigilancia Epidemiológica
                </CardTitle>
