  ...
  },
  {
    ...
    cell: ({ row }: any) => {
      switch (row.original.category) {
        case "cobertura_calidad":
          return "Cobertura de Calidad";
        case "vigilancia_epidemiologica":
          return "Vigilancia Epidemiológica";
        default:
  ...
  },
  {
    ...
    cell: ({ row }: any) => {
      switch (row.original.subCategory) {
        case "paquetes_nino":
          return "Paquetes de Atención Integral del Niño";
        case "paquetes_adolescente":
          return "Paquetes de Atención Integral del Adolescente";
        case "paquetes_gestante":
          return "Paquetes de Atención Integral de la Gestante";
        case "paquetes_adulto_mayor":
          return "Paquetes de Atención Integral del Adulto Mayor";
        case "poblacion_curso_vida":
          return "Población por Curso de Vida";
        case "anemia":
          return "Anemia";
        case "desnutricion":
          return "Desnutrición";
...
interface ContainerHealthNutritionProps {
  uploadedFiles: ExcelRow[];
}

export default function ContainerHealthNutrition({
  uploadedFiles,
}: ContainerHealthNutritionProps) {
  ...
  const filteredFiles = useMemo(() => {
    return uploadedFiles.filter((file) => {
      const categoryText =
        file.category === "cobertura_calidad"
          ? "cobertura de calidad"
          : "vigilancia epidemiológica";
      const subCategoryText =
        file.subCategory === "paquetes_nino"
          ? "paquetes de atención integral del niño"
          : file.subCategory === "paquetes_adolescente"
          ? "paquetes de atención integral del adolescente"
          : file.subCategory === "paquetes_gestante"
          ? "paquetes de atención integral de la gestante"
          : file.subCategory === "paquetes_adulto_mayor"
          ? "paquetes de atención integral del adulto mayor"
          : file.subCategory === "poblacion_curso_vida"
          ? "población por curso de vida"
          : file.subCategory === "anemia"
          ? "anemia"
          : file.subCategory === "desnutricion"
          ? "desnutrición"
          : "dengue";
      return (
