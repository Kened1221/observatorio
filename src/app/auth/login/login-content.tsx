...
export default function LoginWithImagePage() {
  ...
  // Mapa de códigos de error a mensajes legibles para el usuario
  const errorMessages: Record<string, string> = {
    MISSING_CREDENTIALS: "Por favor, ingresa un correo y contraseña.",
    USER_OR_PASSWORD_INCORRECT: "El usuario o la contraseña es incorrecta.",
    AUTHENTICATION_ERROR: "Error de autenticación. Por favor, intenta de nuevo.",
    CredentialsSignin: "Credenciales inválidas o cuenta inactiva.",
  ...
  const handleCredentialsLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        // Mostrar mensaje de error mapeado
      ...
      console.error("Error en handleCredentialsLogin:", error);
